...
const reviews = [
  {
    ...
    desc: "UUnlock an additional 3%* bonus on each dollar you invest in your IRA with our exclusive subscription offer. Enjoy the same benefits for IRA transfers and 401(k) rollovers until April 30.",
    thumbnail:
